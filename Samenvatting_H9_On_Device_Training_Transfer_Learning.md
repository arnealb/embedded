...
![Course overview — dit college opent PART B: Efficient Training](samenvatting_img_h9/slide-03.png)
...
![On-device learning: transfer learning aan de edge i.p.v. de cloud](samenvatting_img_h9/slide-09.png)
...
![Federated learning: enkel gradiënten/gewichten delen, data blijft lokaal](samenvatting_img_h9/slide-10.png)
...
![FedAvg — stap 1 t.e.m. 4](samenvatting_img_h9/slide-14.png)
...
![Wireless technology recognition: classificeer welke draadloze technologie in de lucht zit](samenvatting_img_h9/slide-16.png)
...
![Centralized ML vs Centralized FL vs Decentralized FL](samenvatting_img_h9/slide-17.png)
...
![Centralized federated learning architectuur (CNN-classifier + over-the-air aggregatie)](samenvatting_img_h9/slide-18.png)
...
![Centralized FL resultaten: accuracy vs communication rounds + transfer-data tabel](samenvatting_img_h9/slide-19.png)
...
![Decentralized federated learning met roadside units en directe uitwisseling](samenvatting_img_h9/slide-20.png)
...
![Decentralized FL: CFL vs DFL accuracy-curves](samenvatting_img_h9/slide-21.png)
...
![FedAvg: "the data NEVER leaves local devices"](samenvatting_img_h9/slide-23.png)

FedAvg beloofde: de private data verlaat **nooit** de lokale toestellen — enkel gradiënten/gewichten worden gedeeld. Maar…

![Is dat wel veilig?](samenvatting_img_h9/slide-24.png)
...
![Rethink the safety of gradients: gradiënten worden afgeleid uit model + data](samenvatting_img_h9/slide-27.png)
...
![Privé vs publiek: als je de data uit de gradiënt kan reconstrueren, is delen niet veilig](samenvatting_img_h9/slide-28.png)
...
![Membership inference en property inference uit gradiënten](samenvatting_img_h9/slide-30.png)
...
![Deep Leakage from Gradients: normaal trainen vs de aanval](samenvatting_img_h9/slide-31.png)
...
![Deep Leakage Attack via Gradients Matching](samenvatting_img_h9/slide-32.png)
...
![Deep Leakage resultaten op een vision-model (batch size 1)](samenvatting_img_h9/slide-33.png)
...
![Deep Leakage resultaten op een language-model (BERT)](samenvatting_img_h9/slide-34.png)
...
![Verdediging 1: Gaussische / Laplaciaanse ruis op de gradiënt](samenvatting_img_h9/slide-35.png)
...
![Verdediging 2: gradient compression](samenvatting_img_h9/slide-36.png)
...
![On-device training is challenging: Cloud → Mobile → Tiny AI](samenvatting_img_h9/slide-40.png)
...
![We moeten zowel weights als activation reduceren](samenvatting_img_h9/slide-41.png)
...
![Training memory is the key bottleneck: 452 MB (training) vs 20 MB (inference)](samenvatting_img_h9/slide-42.png)
...
![Antwoord: door de intermediate activations die nodig zijn voor de backward pass](samenvatting_img_h9/slide-43.png)
...
![Activation is de memory-bottleneck in CNN's (ResNet-50 + MobileNetV2)](samenvatting_img_h9/slide-45.png)
...
![Brief information on transfer learning](samenvatting_img_h9/slide-46.png)
...
![Practical cases: p(x) verschilt over domeinen](samenvatting_img_h9/slide-47.png)
![Practical cases: ook p(y|x) kan verschillen](samenvatting_img_h9/slide-48.png)
...
![Transfer learning vs traditionele ML](samenvatting_img_h9/slide-49.png)
...
![Full vs Last: full fine-tuning is accuraat maar duur](samenvatting_img_h9/slide-50.png)
...
![+ BN+Last: fine-tune de BatchNorm-lagen plus de laatste laag](samenvatting_img_h9/slide-51.png)
...
![Parameter-efficiency vertaalt niet naar memory-efficiency](samenvatting_img_h9/slide-52.png)
...
![BN+Last: ook nog een significante accuracy-daling](samenvatting_img_h9/slide-53.png)
...
![Updating weights is memory-expensive — bias-updates niet](samenvatting_img_h9/slide-55.png)
...
![TinyTL: fine-tune bias only → 12× minder geheugen](samenvatting_img_h9/slide-56.png)
...
![Bias-only fine-tuning bespaart geheugen maar schaadt de accuracy](samenvatting_img_h9/slide-57.png)
...
![TinyTL: lite residual learning — extra capaciteit met kleine activations](samenvatting_img_h9/slide-58.png)
...
![Lite residual — principe 1: reduceer de resolutie](samenvatting_img_h9/slide-59.png)
![Lite residual — principe 2: vermijd de inverted bottleneck](samenvatting_img_h9/slide-60.png)
...
![Lite residual: ~4% activation size](samenvatting_img_h9/slide-61.png)
...
![TinyTL: LiteResidual+Bias+Last → +11.6% accuracy met slechts 5MB overhead](samenvatting_img_h9/slide-62.png)
...
![TinyTL: memory-efficient transfer learning — vergelijking met alle baselines](samenvatting_img_h9/slide-63.png)
...
![TinyTL: tot 6.5× geheugenbesparing zonder accuracy-verlies](samenvatting_img_h9/slide-64.png)
...
![Dense, full back-propagation: alle activations bewaren](samenvatting_img_h9/slide-66.png)
...
![Sparse learning: het brein snoeit synapsen tijdens de adolescentie](samenvatting_img_h9/slide-67.png)
...
![Last-layer-only back-propagation: goedkoop maar grote accuracy-daling](samenvatting_img_h9/slide-68.png)
...
![Bias-only back-propagation: LoRA is een speciaal geval](samenvatting_img_h9/slide-69.png)
...
![Sparse back-propagation: niet alle lagen zijn even belangrijk](samenvatting_img_h9/slide-70.png)
![Sparse back-propagation: ook niet alle channels zijn even belangrijk](samenvatting_img_h9/slide-71.png)
...
![Sparse back-propagation: stop de backward pass vroeg](samenvatting_img_h9/slide-72.png)
...
![Sparse back-propagation: enkel een subset van de activations opslaan/berekenen](samenvatting_img_h9/slide-73.png)
...
![Comparison: full vs last-only vs bias-only vs sparse back-propagation](samenvatting_img_h9/slide-74.png)
...
![Lecture Outline — Exam pattern](samenvatting_img_h9/slide-75.png)
